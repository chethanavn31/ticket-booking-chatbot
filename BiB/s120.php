<?php
  ...
  if($bookingData != "N" || $bookingData != "E")  {
    ...
    // echo '---------seatarrrrrrrrrrrrr'.$seatArr[0];
...
<head>
  ...
  <script>
    ...
    //  console.log('TEXTSEATTTTC =========='+$('#txtseat').val());
     var seatArr = JSON.parse($('#txtseat').val());
     if(seatArr != "") {
      //  console.log("NOTTT EMPTTTTYYY");
      //   console.log('ARRRS EATTTTC =========='+seatArr);
